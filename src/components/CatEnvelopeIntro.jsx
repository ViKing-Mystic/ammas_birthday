    ...
    <div className="min-h-[85vh] sm:min-h-[90vh] flex flex-col items-center justify-center p-3 sm:p-6 text-center select-none w-full max-w-lg mx-auto">
      ...
      {step === 'opened' && (
        <div className="w-full space-y-4 sm:space-y-5 animate-in zoom-in-90 fade-in duration-500 px-2">
          ...
          <div className="polaroid-frame p-3 sm:p-4 w-full max-w-[270px] sm:max-w-[320px] mx-auto border-2 border-rosegold-200">
            {/* 1:1 Enlargeable Photo */}
            <EnlargeableImage 
              src={frontPage.envelopePhoto.image} 
              alt="Amma's special memory"
            ...
            {/* Cute Caption Below 1:1 Pic */}
            <div className="pt-2.5 sm:pt-3 pb-1 text-center">
              <p className="font-handwriting text-xl sm:text-3xl text-rosewood-900 leading-snug font-bold break-words">
      ...
      {/* STAGE 3: NO CLICKED ONCE -> Sad Cat with 1:1 Pic Beside It */}
      {step === 'sad_cat' && (
      ...
      {/* STAGE 4: NO CLICKED TWICE -> Crying Cat with 1:1 Pic Beside It */}
      {step === 'crying_cat' && (
        <div className="w-full space-y-4 sm:space-y-5 animate-in zoom-in-95 fade-in duration-400 px-2">
          ...
          {/* Crying Cat + 1:1 Photo Beside It */}
